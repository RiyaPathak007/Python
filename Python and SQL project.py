...
abc = x.connect(host='localhost',user='root',passwd='riyapagal')
...
if abc.is_connected():
    ...
    if not has_run_before:
        ...
        #Priya_Vadini
        c.execute("create TABLE IF NOT EXISTS Priya (PeriodDay varchar(20), Mon varchar(10), \
                    Tue varchar(10), Wed varchar(10), Thu varchar(10), Fri varchar(10))")
        ...
        #Anushka
        c.execute("create TABLE IF NOT EXISTS Anushka (PeriodDay varchar(20), Mon varchar(10), \
                    Tue varchar(10), Wed varchar(10), Thu varchar(10), Fri varchar(10))")
        ...
        #Tushar
        c.execute("create TABLE IF NOT EXISTS Tushar (PeriodDay varchar(20), Mon varchar(10), \
                    Tue varchar(10), Wed varchar(10), Thu varchar(10), Fri varchar(10))")
        ...
        #Attendance
        c.execute("create TABLE IF NOT EXISTS Attendance (t_name CHAR(20))")
    ...
    def period_al(idk):
        idk = t
        sqlt('Attendance')
        c.execute("SELECT * FROM 12b_today")
        rows = c.fetchall()
            ...
            if teach_name:
                ...
                if attend == '$':
                     if t:
                        ...
                        t.remove(assign)
                        c.execute("UPDATE 12b_today SET {day} = %s WHERE PeriodDay = %s", (assign, period))                
                        c.execute(f"UPDATE {assign}_today SET {day} = %s WHERE PeriodDay = %s", ('12b', period))
                else:  
                    c.execute("UPDATE 12b_today SET {day} = %s WHERE PeriodDay = %s", (teach_name, period))
    ...
    def day_end():
        ...
        while current_time < full_day:
            ...
            c.execute(f"CREATE TABLE IF NOT EXISTS 12b_today AS SELECT {day} FROM 12b")
            try:
